...
if __name__ == "__main__":
    ...
    for i in dir_list:
        ...
        f = open(dir_path+"\\"+i,'r', encoding='utf8')
        req = f.read()
        reqfix = fix_content_length(http_response_prv+req)
        print(reqfix)
        creat_http_pcap(http_request=http_request_prv, http_response=http_response_prv+req, pcapname=r''+i)
